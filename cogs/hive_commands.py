...
class HiveCommands(vbu.Cog):
    ...
    async def hive_add(self, ctx: vbu.Context, bee: utils.Bee = None, hive: utils.Hive = None):
        ...
        return await send_method(
            ...
            allowed_mentions=discord.AllowedMentions.none(),
            components=discord.ui.MessageComponents(discord.ui.ActionRow(
                discord.ui.Button(label="View your hive", custom_id="RUNCOMMAND hive list", style=discord.ui.ButtonStyle.secondary),
            )),
        )
    ...
    async def hive_clear(self, ctx: vbu.Context, *, hive: utils.Hive = None):
        ...
        return await send_method(
            ...
            components=discord.ui.MessageComponents(discord.ui.ActionRow(
                discord.ui.Button(label="See your bees", custom_id="RUNCOMMAND bee list", style=discord.ui.ButtonStyle.secondary),
                discord.ui.Button(label="See your hives", custom_id="RUNCOMMAND hive list", style=discord.ui.ButtonStyle.secondary),
                discord.ui.Button(label="See your inventory", custom_id="RUNCOMMAND inventory", style=discord.ui.ButtonStyle.secondary),
            )),
        )
